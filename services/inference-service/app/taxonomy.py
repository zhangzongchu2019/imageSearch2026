...
L1_CATEGORIES: Dict[int, dict] = {
    ...
    1005: {
        "name": "房地产类",
        "prompts": [
            "a photo of a house building exterior architecture",
            "a real estate listing photo of property apartment villa",
            "an aerial photo of residential neighborhood buildings",
            "a photo of a modern house facade front yard",
            "a commercial real estate photo of an office building storefront",
        ],
    },
    1006: {
        "name": "五金建材类",
        "prompts": [
            "a product photo of metal screws bolts nuts nails washers hardware",
            "a photo of plumbing fittings pipes PVC valves faucets",
            "a product photo of a power drill electric saw angle grinder",
            "a product photo of ceramic tiles flooring paint wallpaper building materials",
        ],
    },
    1007: {
        "name": "家具类",
        "prompts": [
            "a product photo of a sofa couch armchair on white background",
            "a product photo of a wooden table desk dining table",
            "a product photo of a cabinet wardrobe bookshelf dresser",
            "a product photo of a bed frame headboard mattress",
            "a product photo of a lamp chandelier pendant light fixture",
        ],
    },
    1008: {
        "name": "化妆品类",
        "prompts": [
            "a product photo of lipstick eyeshadow palette foundation makeup",
            "a product photo of skincare serum moisturizer face cream bottle",
            "a product photo of perfume fragrance cologne glass bottle",
            "a product photo of makeup brushes beauty sponge cosmetic tools",
        ],
    },
    1009: {
        "name": "小家电类",
        "prompts": [
            "a product photo of an electric kitchen appliance blender juicer coffee maker",
            "a product photo of a hair dryer straightener electric shaver on white background",
            "a product photo of a robot vacuum cleaner air purifier humidifier",
            "a product photo of an electric iron steamer toaster rice cooker",
        ],
    },
    1010: {
        "name": "手机类",
    ...
    1013: {
        "name": "玩具类",
        "prompts": [
            "a product photo of a children plastic toy colorful plaything",
            "a photo of LEGO building blocks jigsaw puzzle board game",
            "a photo of a stuffed plush teddy bear doll action figure",
            "a product photo of a remote control toy car robot for kids",
            "a photo of children playing with toys in a playroom",
        ],
    },
    1014: {
        "name": "运动户外类",
        "prompts": [
            "a product photo of sports equipment dumbbell yoga mat",
            "a photo of a bicycle helmet camping tent sleeping bag",
            "a product photo of a basketball football tennis racket",
            "a photo of fitness gym exercise equipment treadmill",
            "a product photo of outdoor hiking backpack climbing gear",
        ],
    },
    1015: {
        "name": "汽车配件类",
        "prompts": [
            "a product photo of a car tire wheel rim alloy wheel",
            "a product photo of an automotive headlight tail light car LED",
            "a photo of a car seat cover steering wheel cover floor mat",
            "a product photo of a car dash cam rearview mirror GPS mount",
        ],
    },
    1016: {
        "name": "办公用品类",
        "prompts": [
            "a product photo of ballpoint pens pencils markers highlighters",
            "a product photo of a paper notebook journal diary planner",
            "a product photo of a stapler tape dispenser paper clips scissors ruler",
            "a product photo of file folders binders document organizer storage box",
        ],
    },
    1017: {
        "name": "钟表类",
