...
INFERENCE = "http://172.21.0.8:8090"
WORKERS = 30
...
def do_one(pk, url, wid):
    try:
        ...
        r = httpx.post(f"{INFERENCE}/api/v1/extract", json={"image_b64": b64}, timeout=15)
...
def main():
    log.info(f"=== Task 17: L2 补全 ({WORKERS} threads) ===")
